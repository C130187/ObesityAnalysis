...
```
We observed two patterns of missing data. 
...
No distinct patterns can be found. Overall, this dataset seems much more sparse than the Obesity-Behavioural dataset.

As compared to 2019, 2018 has lesser number of missing values. Hence, in all our analysis at the state-level for these questions, we used data from 2018 instead of 2019 as recent data. 
